...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'microsoft@luciochen.com',
  ...
  protectedRoutes: ['/215A Recording', '/216A Recording','/archive','/UCLA','/work'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/luciochen233',
    }
  ],
